...
export class GameComponent extends Component {
    ...
    /** 异步加载资源 */
    loadAsync<T extends Asset>(bundleName: string, paths: string | string[], type: AssetType<T> | null, onProgress: ProgressCallback | null): Promise<T>;
    loadAsync<T extends Asset>(bundleName: string, paths: string | string[], onProgress: ProgressCallback | null): Promise<T>;
    ...
    loadAsync<T extends Asset>(paths: string | string[], type: AssetType<T> | null, onProgress: ProgressCallback | null): Promise<T>;
    loadAsync<T extends Asset>(paths: string | string[], onProgress: ProgressCallback | null): Promise<T>;
